    ...
    return (
        <section className='section'>
            ...
            <div className='section text-center'>
                <h2 data-aos='fade-in' data-aos-once='true' data-aos-duration='2000' className='section__title'>Submission</h2>
                <div data-aos='fade-in' data-aos-once='true' data-aos-duration='2000' className='section__content'>Submitted papers
                    ...
                    <div data-aos='fade-in' data-aos-once='true' data-aos-duration='2000' className='left'><a href='#'>Click here&nbsp;</a><b>for submission of paper</b></div>
                </div>
            </div>
